...
export default function DiscussForm(props) {
  ...
  const submitEmail = () => {
    const { name, company, email, phone, EdTechIdea } = data;
    ...
    <section className="flex flex-col container mx-auto mt-10 justify-center">
      <Fade bottom>
        ...
        <p className="font-light text-lg text-gray-400 text-center mb-12">
          ...
          Please fill out the form below to discuss your EdTech and we'll get
        ...
        <div className="flex flex-col">
          ...
          <div className="mx-auto">
            <Form
              ...
              name="EdTechIdea"
              type="textarea"
              value={data.EdTechIdea}
              placeholder="Explain about your EdTech idea"
              className=""
              onChange={props.onChange}
            />
          </div>
