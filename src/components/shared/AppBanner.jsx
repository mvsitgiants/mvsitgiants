    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        <motion.p
          ...
          className="font-general-medium mt-4 text-lg md:text-[18px] lg:text-xl xl:text-xl text-center sm:text-left leading-normal text-gray-500 dark:text-gray-200"
        >
